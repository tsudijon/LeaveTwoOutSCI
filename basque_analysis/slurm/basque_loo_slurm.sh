...
#SBATCH -J basque_simulation_loo # name of the job

ml R/3.5.1
ml gcc
# size.resampled.dataset, alpha, tau, mc_samples

Rscript basque_loo_poweranalysis_slurm.R 15 0.05 0 20

Rscript basque_loo_poweranalysis_slurm.R 15 0.05 -1.5 20

Rscript basque_loo_poweranalysis_slurm.R 15 0.05 -3.0 20

Rscript basque_loo_poweranalysis_slurm.R 15 0.05 -4.5 20