...
Rscript basque_valid_ltojk_poweranalysis_slurm.R 15 0.1 0 20

Rscript basque_valid_ltojk_poweranalysis_slurm.R 15 0.1 -0.75 20

Rscript basque_valid_ltojk_poweranalysis_slurm.R 15 0.1 -1.5 20

Rscript basque_valid_ltojk_poweranalysis_slurm.R 15 0.1 -3.0 20

Rscript basque_valid_ltojk_poweranalysis_slurm.R 15 0.1 -4.5 20